...
const cartButton = cart.querySelector('.cart button');

// 이벤트 바인딩
myCoupangButton.addEventListener('mouseenter', addActive);
myCoupangButton.addEventListener('mouseleave', removeActive);
myCoupangButton.addEventListener('focusin', addActive);
myCoupangButton.addEventListener('focusout', removeActive);
